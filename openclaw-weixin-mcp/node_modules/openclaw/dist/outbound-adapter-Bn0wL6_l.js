...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-BOrd8HRU.js";
import { n as resolveOutboundSendDep } from "./send-deps-jTRjIYIm.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-DrqhTQYg.js";
...
import { m as DiscordError } from "./discord-BzIosOJb.js";
import { t as chunkDiscordTextWithMode } from "./chunk-B3YNEOuT.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-BAazq1Aa.js";
import { t as createDiscordSendReceipt } from "./send.receipt-COBSsHa4.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-DkCGnEL4.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-DURfuH-f.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-BwlPTQbj.js");
