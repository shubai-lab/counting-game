...
declare const ALL_PROXY_ENV_KEYS: readonly ["http_proxy", "https_proxy", "HTTP_PROXY", "HTTPS_PROXY", "GLOBAL_AGENT_HTTP_PROXY", "GLOBAL_AGENT_HTTPS_PROXY", "GLOBAL_AGENT_FORCE_GLOBAL_AGENT", "no_proxy", "NO_PROXY", "GLOBAL_AGENT_NO_PROXY", "OPENCLAW_PROXY_ACTIVE", "OPENCLAW_PROXY_LOOPBACK_MODE"];
...
export declare function registerManagedProxyGatewayLoopbackNoProxy(url: string): (() => void) | undefined;
