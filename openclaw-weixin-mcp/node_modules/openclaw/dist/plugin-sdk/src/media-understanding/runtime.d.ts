...
export declare function extractStructuredWithModel(params: ExtractStructuredWithModelParams): Promise<import("openclaw/plugin-sdk/media-understanding").StructuredExtractionResult>;
