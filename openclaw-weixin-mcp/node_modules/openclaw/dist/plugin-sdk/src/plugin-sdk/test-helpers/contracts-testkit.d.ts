...
export declare function createPluginRegistryFixture(config?: OpenClawConfig, params?: {
    ...
    registry: {
        ...
        registerModelCatalogProvider: (record: PluginRecord, provider: import("../plugin-entry.js").UnifiedModelCatalogProviderPlugin) => void;
        ...
        registerSessionAction: (record: PluginRecord, action: import("../plugin-entry.js").PluginSessionActionRegistration) => void;
