...
export declare function createHookRunnerWithRegistry(hooks: Array<{
    ...
    runner: {
        ...
        runBeforeAgentRun: (event: import("./hook-types.ts").PluginHookBeforeAgentRunEvent, ctx: PluginHookAgentContext) => Promise<import("./hook-decision-types.ts").GateHookResult<import("./hook-decision-types.ts").InputGateDecision> | undefined>;
