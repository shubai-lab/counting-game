...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-BxqheYvy.js";
...
import { i as setPathExistingStrict } from "./path-utils-Dw-vVQlL.js";
import { n as discoverConfigSecretTargets } from "./target-registry-BBvvwcuS.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-5xE1dPMK.js";
import { n as formatConfigIssueLines } from "./issue-format-C1rff-gs.js";
import { r as normalizeTalkSection } from "./talk-CbjHCImG.js";
...
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-Q4WXUmmu.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-C32GYnQD.js";
import { n as getLoadedChannelPlugin } from "./registry-BdfZSqhE2.js";
import { i as listRouteBindings } from "./bindings-DquOUUGd.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-D3a-EsYw.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-Bo92Y_3C.js";
import { t as note } from "./note-Bg5THHEx.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-PF4TfNSo.js";
import { t as asObjectRecord } from "./object-CfbLD2Ci.js";
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-KJ83eQGz.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-Bw5vSmG3.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-sKGZ_R4X.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-DCAXIgDC.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-B4bv7q2M.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-Dv4hOM1C.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-BdvaHJym.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-k2hpr6zn.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-_xVks1LB.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-CahN6tJ4.js");
		emitDoctorNotes({
			note,
