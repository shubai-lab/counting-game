...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-DL0trrAI.js";
import { i as isNixMode } from "./paths-Cnwfh6dH.js";
import { _ as sleep } from "./utils-CKsuXgDI.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-DlaHO4z7.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-DWEAPKsr.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-DHmOxzz2.js";
import { a as isDiagnosticsEnabled, b as runWithDiagnosticTraceContext, d as createDiagnosticTraceContext, l as setDiagnosticsEnabledForProcess } from "./diagnostic-events-BkhOFI0h.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-DLRoKDlF.js";
import { t as isContainerEnvironment } from "./container-environment-DQOYng0C.js";
import { g as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-Gkm1Cz9b.js";
import { a as createAuthRateLimiter } from "./auth-rate-limit-CBhSvowG.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-e6hlqNhL.js";
import { n as resolveGatewayAuth } from "./auth-resolve-CX86Ah73.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-5xE1dPMK.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-CmrI3EDp.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE } from "./operator-scopes-CpnZaPqz.js";
import "./method-scopes-CQOTpXrQ.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-CvCdHpp_.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DLIxCAM0.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-CFKT2mp_.js";
import { i as resolveMainSessionKey } from "./main-session-BkilxHe0.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-CF1z2CuQ.js";
...
import { _ as stopDiagnosticHeartbeat, g as startDiagnosticHeartbeat } from "./diagnostic-DrGtZgCh.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-C9qxy_9I.js";
import { l as getTotalQueueSize } from "./command-queue-DB7xEnvP.js";
import { r as resolveCronStorePath } from "./store-CghHeK-D.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-DvTwLiTi.js";
import { a as setFallbackGatewayContextResolver } from "./server-plugins-BFB8Y6GY.js";
...
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-DP56WFmQ.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-CjqaGuge.js";
...
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-DBTbbBna.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-1JM0IS0k.js";
import { t as GatewayLockError } from "./gateway-lock-vUq4OmnC.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-vj1J24Md.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-B0oWiJ-k.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-DAdcLkHa.js";
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-DHpB5sYf.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-D_t6NNo9.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-D-GXgVp4.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-BLRzi45J.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-BkI8BoBR.js";
import { t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./server-startup-unavailable-methods-DR8VbiDR.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-BEfor4Kj.js";
import { n as isProtectedPluginRoutePathFromContext, r as resolvePluginRoutePathContext } from "./route-match-BgKnQWSR.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-CUHH1xfl.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-skurPVBc.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-BekQqXLT.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-Bghj30Ho.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-CRNChb3C.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-CCO2kcj-.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-DAp84bTB.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DC9TgRR5.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-DXmDTH5q.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-DP1-sx4w.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-D3jyYTHN.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-D2WNx_oN.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-BDHx8_in.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-DxIQ4RZk.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-b5qPBoDk.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-BcWW5wnm.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-DBKknpfW.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-8-8mOYS4.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-8-8mOYS4.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-D1bm0cct.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-Cn35x1q7.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-Cd490zZC.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-B16vw5Hg.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-Dcui0kT2.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-D1bm0cct.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-B-jsfe-3.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-BdlDl_mG.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-D2aenL3D.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-BBlEl_rJ.js");
	const reloadHandlersModulePromise = import("./server-reload-handlers-CQ4L3fUC.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-Cwq126jo.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-DHkb-DlC.js");
	...
	const { createChannelManager } = await import("./server-channels-Yroq926v.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-CKqx-zfo.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-BF2S_78B.js"), import("./server-runtime-services-BnuquflJ.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-hqit3anN.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-DRV9HVxE.js"),
				import("./server-plugin-bootstrap-CY9gGzEW.js"),
				import("./services-px5NopI_.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-CslsVvbA.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-CY9gGzEW.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-O_wrJ1Jm.js");
		const { listPluginNodeCapabilities } = await import("./route-capability-DKzXWXfC.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-DIpzvALt.js");
