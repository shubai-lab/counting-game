...
import { p as normalizeThinkLevel } from "./thinking-ix_990qw.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-DA7jZ41J.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-CpnZaPqz.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-DO7ujqcl.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-a4exFSck.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-G_zj7dLG.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-Bg_OIUJn.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-VRXWv5rs.js";
import { r as loadModelCatalog } from "./model-catalog-Bej-qOX2.js";
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-CL9ZQP7k.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-CRZ3dal0.js";
import { C as setTtsEnabled, E as setTtsProvider, T as setTtsPersona, _ as resolveTtsConfig, d as listSpeechVoices, f as listTtsPersonas, h as resolveExplicitTtsOverrides, k as textToSpeech, o as getTtsPersona, s as getTtsProvider, v as resolveTtsPrefsPath } from "./tts-runtime-C0bCA1Ve.js";
import "./tts-BO4bGOGk.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CATO_xkV.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-DXf4_m8K.js";
import { i as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-CvN-bC19.js";
import { t as resolveMemorySearchConfig } from "./memory-search-Dn2Ao10S.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-B5I_kOQU.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-Cf-lVQPJ.js";
...
import { t as collectOption } from "./helpers-CSBw61zy.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-Rn1iFMQb.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-aulFgURT.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-Buoxqzi2.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-D1sGUVJ4.js");
