...
import "./accounts-dBYbLVC_.js";
import "./runtime-api-XMwKNinH.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-DuVzQz_M.js";
import { t as sendMessageZalo } from "./send-BCyGfM4B.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BzljCsqz.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-CNGolQaM.js");
