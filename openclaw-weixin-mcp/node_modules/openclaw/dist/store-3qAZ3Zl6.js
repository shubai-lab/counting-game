...
import { t as writeTextAtomic } from "./json-files-CahFuwKs.js";
import { t as createSubsystemLogger } from "./subsystem-DLRoKDlF.js";
import { l as listDeliverableMessageChannels, u as normalizeMessageChannel } from "./message-channel-s-A-ruKR.js";
...
import { i as isSessionArchiveArtifactName, n as isCompactionCheckpointTranscriptFileName, r as isPrimarySessionTranscriptFileName, s as isTrajectorySessionArtifactName } from "./artifacts-CZN5dsCJ.js";
import { i as resolveSessionFilePath } from "./paths-kGAxo7MN.js";
import { D as getFileStatSnapshot, S as shouldRunSessionEntryMaintenance, _ as getActiveSessionMaintenanceWarning, c as clearSessionStoreCaches, d as getSerializedSessionStore, f as isSessionStoreCacheEnabled, g as capEntryCount, h as writeSessionStoreCache, i as collectSessionMaintenancePreserveKeys, m as takeMutableSessionStoreCache, n as normalizeSessionStore, o as normalizeStoreSessionKey, p as setSerializedSessionStore, r as resolveMaintenanceConfig, s as resolveSessionStoreEntry, t as loadSessionStore, u as dropSessionStoreObjectCache, v as pruneQuotaSuspensions, x as shouldPreserveMaintenanceEntry, y as pruneStaleEntries } from "./store-load-cmAGD4uk.js";
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath } from "./paths-DQ81gelS.js";
import { a as normalizeChannelId, i as listChannelPlugins, n as getLoadedChannelPlugin } from "./registry-BdfZSqhE2.js";
...
import { n as mergeSessionEntry, r as mergeSessionEntryPreserveActivity } from "./types-k3POMgTC.js";
...
function loadTrajectoryCleanupRuntime() {
	trajectoryCleanupRuntimePromise ??= import("./cleanup-CiW56B_f.js");
...
//#endregion
export { enforceSessionDiskBudget as _, saveSessionStore as a, updateSessionStoreEntry as c, deriveGroupSessionPatch as d, deriveSessionMetaPatch as f, resolveGroupSessionKey as g, buildGroupDisplayName as h, runQuotaSuspensionMaintenance as i, clearSessionStoreCacheForTest as l, snapshotSessionOrigin as m, readSessionUpdatedAt as n, updateLastRoute as o, deriveSessionOrigin as p, recordSessionMetaFromInbound as r, updateSessionStore as s, archiveRemovedSessionTranscripts as t, drainSessionStoreWriterQueuesForTest as u, pruneUnreferencedSessionArtifacts as v, resolveSessionArtifactCanonicalPathsForEntry as y };
