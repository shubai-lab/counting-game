...
import { n as isAutoLinkedFileRef } from "./auto-linked-file-ref-BdubrmnM.js";
import "./channel-message-CmG6T1ry.js";
import "./text-autolink-runtime-CQQI2OWF.js";
import { t as require_src } from "./src-MAilWfrw.js";
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-B3fWSEdS.js";
...
import { r as buildMatrixReactionContent } from "./reaction-common-Bk3_Yd6D.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-CPGLnKIQ.js";
import { t as fromBuffer } from "./lib-7YqM1lnY.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-CoeIVkzn.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-HLKxvt8u.js";
import { l as toRatio, n as decodeString } from "./Util-BCVterdo.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-jlu0djgn.js";
import { t as APEv2Parser } from "./APEv2Parser-CKKaWBvp.js";
import { r as hasID3v1Header } from "./ID3v1Parser-CPtEyarf.js";
import { i as isStrictDirectRoom } from "./direct-room-DjlSEJpA.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-BZGOt8uV.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-D_OYiCu4.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DR2IkQ06.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-JuBX4FWg.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DhZjQhSP.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-t1BDz-Mz.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DRYotz_c.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-Dgfs7a44.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-B22mDuP1.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-D42G9uFD.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BoHgEa32.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-C8KFhBQu.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-2a35QhXZ.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DHpDCJZe.js")).WaveParser;
	}
};
//#endregion
