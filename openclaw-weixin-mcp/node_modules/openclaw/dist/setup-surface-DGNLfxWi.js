...
import { o as isPrivateOrLoopbackHost } from "./net-Gkm1Cz9b.js";
import "./string-coerce-runtime-Ce59bOpy.js";
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-Cm8y4liy.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-CcYLcRNJ.js";
...
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-D0-ECmEW.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CN2fnEaV.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-BLkxxEzX.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-DWYwDVbi.js";
import { n as updateMatrixAccountConfig } from "./config-update-BnPiKObl.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-C3IIIb5H.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-BkhrQy69.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-CkucejC5.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-DubrJ-e_.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-DkzXTpZF.js");
