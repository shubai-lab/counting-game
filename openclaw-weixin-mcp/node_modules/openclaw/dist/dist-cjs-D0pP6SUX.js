...
import { C as client_exports, E as init_schema, F as toUtf8$2, G as dateToUtcString$2, H as nv, J as parseRfc7231DateTime, K as parseEpochTimestamp, L as fromUtf8, N as getSmithyContext$1, O as TypeRegistry, P as require_dist_cjs$23, R as fromBase64$2, S as init_config, U as _parseEpochTimestamp, V as NumericValue, W as LazyJsonString, _ as serde_exports, a as FromStringShapeDeserializer, b as init_endpoints, c as RpcProtocol, d as HttpRequest$2, f as SerdeContext, g as init_serde, h as generateIdempotencyToken, i as HttpInterceptingShapeDeserializer, j as deref, k as NormalizedSchema, l as HttpBindingProtocol, m as collectBody$1, n as protocols_exports$1, o as determineTimestampFormat, p as extendedEncodeURIComponent, q as parseRfc3339DateTimeWithOffset, r as HttpInterceptingShapeSerializer, s as requestBuilder, t as init_protocols$1, w as init_client, x as config_exports, y as endpoints_exports } from "./protocols-CO3NMy6S.js";
import { t as require_dist_cjs$24 } from "./dist-cjs-DQR3Meck.js";
import { a as init_retry, i as require_dist_cjs$25, n as client_exports$1, o as retry_exports, r as init_client$1, s as setCredentialFeature, t as require_dist_cjs$26 } from "./dist-cjs-DS9W42km.js";
import { n as require_dist_cjs$27 } from "./dist-cjs-DDGLQYvl.js";
...
var require_dist_cjs$20 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var protocolHttp = require_dist_cjs$24();
...
var require_recursionDetectionMiddleware = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const protocol_http_1 = require_dist_cjs$24();
...
var import_dist_cjs$22, ProtocolLib;
var init_ProtocolLib = __esmMin((() => {
	init_schema();
	import_dist_cjs$22 = require_dist_cjs$27();
	ProtocolLib = class {
		queryCompat;
		errorRegistry;
		...
		decorateServiceException(exception, additions = {}) {
			if (this.queryCompat) {
				...
				const error = (0, import_dist_cjs$22.decorateServiceException)(exception, additions);
			...
			return (0, import_dist_cjs$22.decorateServiceException)(exception, additions);
		}
...
var import_dist_cjs$20, import_dist_cjs$21, collectBodyString;
var init_common = __esmMin((() => {
	import_dist_cjs$20 = require_dist_cjs$27();
	import_dist_cjs$21 = require_dist_cjs$22();
	collectBodyString = (streamBody, context) => (0, import_dist_cjs$20.collectBody)(streamBody, context).then((body) => (context?.utf8Encoder ?? import_dist_cjs$21.toUtf8)(body));
}));
//#endregion
...
var import_dist_cjs$19, JsonShapeDeserializer;
var init_JsonShapeDeserializer = __esmMin((() => {
	...
	JsonShapeDeserializer = class extends SerdeContextConfig {
		...
		_read(schema, value) {
			...
			if (ns.isBlobSchema() && typeof value === "string") return (0, import_dist_cjs$19.fromBase64)(value);
...
var import_dist_cjs$18, JsonShapeSerializer;
var init_JsonShapeSerializer = __esmMin((() => {
	init_protocols$1();
	init_schema();
	init_serde();
	import_dist_cjs$18 = require_dist_cjs$17();
	init_ConfigurableSerdeContext();
	init_jsonReplacer();
		...
		_write(schema, value, container) {
			...
			if (isObject) {
				...
				if (value instanceof Uint8Array && (ns.isBlobSchema() || ns.isDocumentSchema())) {
					...
					return (this.serdeContext?.base64Encoder ?? import_dist_cjs$18.toBase64)(value);
				}
...
var import_dist_cjs$17, awsExpectUnion;
var init_awsExpectUnion = __esmMin((() => {
	import_dist_cjs$17 = require_dist_cjs$27();
	awsExpectUnion = (value) => {
		if (value == null) return;
		if (typeof value === "object" && "__type" in value) delete value.__type;
		return (0, import_dist_cjs$17.expectUnion)(value);
	};
}));
//#endregion
...
var import_dist_cjs$14, import_dist_cjs$15, import_dist_cjs$16, XmlShapeDeserializer;
var init_XmlShapeDeserializer = __esmMin((() => {
	import_dist_cjs$14 = require_dist_cjs$16();
	init_protocols$1();
	init_schema();
	import_dist_cjs$15 = require_dist_cjs$27();
	import_dist_cjs$16 = require_dist_cjs$22();
	init_ConfigurableSerdeContext();
	init_UnionSerde();
	XmlShapeDeserializer = class extends SerdeContextConfig {
		...
		read(schema, bytes, key) {
			...
			const xmlString = (this.serdeContext?.utf8Encoder ?? import_dist_cjs$16.toUtf8)(bytes);
		...
		parseXml(xml) {
			if (xml.length) {
				let parsedObj;
				try {
					parsedObj = (0, import_dist_cjs$14.parseXML)(xml);
				} catch (e) {
				...
				return (0, import_dist_cjs$15.getValueFromTextNode)(parsedObjToReturn);
			}
			return {};
		}
	};
...
var import_dist_cjs$12, import_dist_cjs$13, QueryShapeSerializer;
var init_QueryShapeSerializer = __esmMin((() => {
	init_protocols$1();
	init_schema();
	init_serde();
	import_dist_cjs$12 = require_dist_cjs$27();
	import_dist_cjs$13 = require_dist_cjs$17();
	init_ConfigurableSerdeContext();
		...
		write(schema, value, prefix = "") {
			...
			if (ns.isBlobSchema()) {
				if (typeof value === "string" || value instanceof Uint8Array) {
					...
					this.writeValue((this.serdeContext?.base64Encoder ?? import_dist_cjs$13.toBase64)(value));
				}
				...
				if (value instanceof Date) {
					...
					switch (determineTimestampFormat(ns, this.settings)) {
						case 5:
							...
							break;
						case 6:
							this.writeValue((0, import_dist_cjs$12.dateToUtcString)(value));
							break;
						case 7:
...
var import_dist_cjs$10, import_dist_cjs$11, parseXmlBody, parseXmlErrorBody, loadRestXmlErrorCode;
var init_parseXmlBody = __esmMin((() => {
	import_dist_cjs$10 = require_dist_cjs$16();
	...
	parseXmlBody = (streamBody, context) => collectBodyString(streamBody, context).then((encoded) => {
		if (encoded.length) {
			let parsedObj;
			try {
				parsedObj = (0, import_dist_cjs$10.parseXML)(encoded);
			} catch (e) {
			...
			return (0, import_dist_cjs$11.getValueFromTextNode)(parsedObjToReturn);
		}
		return {};
	});
...
var import_dist_cjs$7, import_dist_cjs$8, import_dist_cjs$9, XmlShapeSerializer;
var init_XmlShapeSerializer = __esmMin((() => {
	import_dist_cjs$7 = require_dist_cjs$16();
	init_protocols$1();
	init_schema();
	init_serde();
	import_dist_cjs$8 = require_dist_cjs$27();
	import_dist_cjs$9 = require_dist_cjs$17();
	init_ConfigurableSerdeContext();
	XmlShapeSerializer = class extends SerdeContextConfig {
		...
		write(schema, value) {
			...
			else if (ns.isBlobSchema()) this.byteBuffer = "byteLength" in value ? value : (this.serdeContext?.base64Decoder ?? import_dist_cjs$9.fromBase64)(value);
			else {
		...
		writeStruct(ns, value, parentXmlns) {
			...
			const structXmlNode = import_dist_cjs$7.XmlNode.of(name);
			...
			for (const [memberName, memberSchema] of ns.structIterator()) {
				...
				if (val != null || memberSchema.isIdempotencyToken()) {
					...
					if (memberSchema.isListSchema()) this.writeList(memberSchema, val, structXmlNode, xmlns);
						...
						const memberNode = import_dist_cjs$7.XmlNode.of(memberSchema.getMergedTraits().xmlName ?? memberSchema.getMemberName());
			...
			if ($unknown && ns.isUnionSchema() && Array.isArray($unknown) && Object.keys(value).length === 1) {
				const [k, v] = $unknown;
				const node = import_dist_cjs$7.XmlNode.of(k);
				if (typeof v !== "string") if (value instanceof import_dist_cjs$7.XmlNode || value instanceof import_dist_cjs$7.XmlText) structXmlNode.addChildNode(value);
		...
		writeList(listMember, array, container, parentXmlns) {
			...
			const writeItem = (container, value) => {
				if (listValueSchema.isListSchema()) this.writeList(listValueSchema, Array.isArray(value) ? value : [value], container, xmlns);
					...
					const listItemNode = import_dist_cjs$7.XmlNode.of(flat ? listTraits.xmlName ?? listMember.getMemberName() : listValueTraits.xmlName ?? "member");
			...
			if (flat) {
				...
				const listNode = import_dist_cjs$7.XmlNode.of(listTraits.xmlName ?? listMember.getMemberName());
		...
		writeMap(mapMember, map, container, parentXmlns, containerIsMap = false) {
			...
			const addKeyValue = (entry, key, val) => {
				const keyNode = import_dist_cjs$7.XmlNode.of(keyTag, key);
				const [keyXmlnsAttr, keyXmlns] = this.getXmlnsAttribute(mapKeySchema, xmlns);
				if (keyXmlns) keyNode.addAttribute(keyXmlnsAttr, keyXmlns);
				entry.addChildNode(keyNode);
				let valueNode = import_dist_cjs$7.XmlNode.of(valueTag);
			...
			if (flat) for (const key in map) {
				const val = map[key];
				if (sparse || val != null) {
					const entry = import_dist_cjs$7.XmlNode.of(mapTraits.xmlName ?? mapMember.getMemberName());
				...
				let mapNode;
				if (!containerIsMap) {
					mapNode = import_dist_cjs$7.XmlNode.of(mapTraits.xmlName ?? mapMember.getMemberName());
				...
				for (const key in map) {
					const val = map[key];
					if (sparse || val != null) {
						const entry = import_dist_cjs$7.XmlNode.of("entry");
						addKeyValue(entry, key, val);
		...
		writeSimple(_schema, value) {
			...
			if (value && typeof value === "object") if (ns.isBlobSchema()) nodeContents = (this.serdeContext?.base64Encoder ?? import_dist_cjs$9.toBase64)(value);
			else if (ns.isTimestampSchema() && value instanceof Date) switch (determineTimestampFormat(ns, this.settings)) {
				case 5:
					nodeContents = value.toISOString().replace(".000Z", "Z");
					break;
				case 6:
					nodeContents = (0, import_dist_cjs$8.dateToUtcString)(value);
					break;
				case 7:
		...
		writeSimpleInto(_schema, value, into, parentXmlns) {
			...
			const ns = NormalizedSchema.of(_schema);
			const content = new import_dist_cjs$7.XmlText(nodeContents);
			const [xmlnsAttr, xmlns] = this.getXmlnsAttribute(ns, parentXmlns);
...
var import_dist_cjs$5, HttpApiKeyAuthSigner;
var init_httpApiKeyAuth = __esmMin((() => {
	init_protocols$1();
	import_dist_cjs$5 = require_dist_cjs$23();
	HttpApiKeyAuthSigner = class {
		async sign(httpRequest, identity, signingProperties) {
			...
			if (signingProperties.in === import_dist_cjs$5.HttpApiKeyAuthLocation.QUERY) clonedRequest.query[signingProperties.name] = identity.apiKey;
			else if (signingProperties.in === import_dist_cjs$5.HttpApiKeyAuthLocation.HEADER) clonedRequest.headers[signingProperties.name] = signingProperties.scheme ? `${signingProperties.scheme} ${identity.apiKey}` : identity.apiKey;
...
var require_dist_cjs$11 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var urlParser = require_dist_cjs$12();
...
var require_dist_cjs$10 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var utilEndpoints = require_dist_cjs$11();
	var protocolHttp = require_dist_cjs$24();
	var client = (init_client$1(), __toCommonJS(client_exports$1));
	var utilRetry = require_dist_cjs$25();
...
var init_getDateHeader = __esmMin((() => {
	import_dist_cjs$4 = require_dist_cjs$24();
...
var init_AwsSdkSigV4ASigner = __esmMin((() => {
	import_dist_cjs$2 = require_dist_cjs$24();
	init_utils();
...
var init_resolveAwsSdkSigV4AConfig = __esmMin((() => {
	init_dist_es();
	import_dist_cjs$1 = require_dist_cjs$26();
...
var require_dist_cjs$5 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var utilConfigProvider = require_dist_cjs$14();
...
var require_stsRegionDefaultResolver = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const node_config_provider_1 = require_dist_cjs$3();
...
//#endregion
export { require_dist_cjs$15 as A, require_dist_cjs$22 as B, dist_es_exports as C, getHttpSigningPlugin as D, DefaultIdentityProviderConfig as E, require_dist_cjs$17 as F, require_dist_cjs$18 as I, require_dist_cjs$19 as L, protocols_exports as M, AwsQueryProtocol as N, getHttpAuthSchemeEndpointRuleSetPlugin as O, AwsRestJsonProtocol as P, require_dist_cjs$20 as R, require_dist_cjs$13 as S, NoAuthSigner as T, require_dist_cjs$8 as _, require_dist_cjs$4 as a, require_dist_cjs$11 as b, init_httpAuthSchemes as c, resolveAwsSdkSigV4AConfig as d, NODE_AUTH_SCHEME_PREFERENCE_OPTIONS as f, require_dist_cjs$7 as g, require_dist_cjs$6 as h, require_dist_cjs$3 as i, init_protocols as j, require_dist_cjs$14 as k, resolveAwsSdkSigV4Config as l, AwsSdkSigV4Signer as m, require_dist_cjs$1 as n, require_dist_cjs$5 as o, AwsSdkSigV4ASigner as p, require_dist_cjs$2 as r, httpAuthSchemes_exports as s, require_dist_cjs as t, NODE_SIGV4A_CONFIG_OPTIONS as u, require_dist_cjs$9 as v, init_dist_es as w, require_dist_cjs$12 as x, require_dist_cjs$10 as y, require_dist_cjs$21 as z };
