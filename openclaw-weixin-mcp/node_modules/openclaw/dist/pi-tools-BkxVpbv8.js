...
import { d as resolveGatewayMessageChannel } from "./message-channel-s-A-ruKR.js";
import { n as assertSandboxPath } from "./sandbox-paths-BOOkw4YG.js";
import { i as toRelativeSandboxPath, n as resolveWorkspaceRoot, r as resolvePathFromInput } from "./workspace-dir-DPcc1MHX.js";
import { _ as wrapToolMemoryFlushAppendOnlyWrite, d as createHostWorkspaceEditTool, f as createHostWorkspaceWriteTool, g as createSandboxedWriteTool, h as createSandboxedReadTool, m as createSandboxedEditTool, p as createOpenClawReadTool, t as createOpenClawTools, u as resolveToolLoopDetectionConfig, v as wrapToolWorkspaceRootGuard, x as resolveOpenClawPluginToolsForOptions, y as wrapToolWorkspaceRootGuardWithOptions } from "./openclaw-tools-BfDU2PXL.js";
import { a as resolveToolProfilePolicy, d as EXEC_TOOL_DISPLAY_SUMMARY, f as PROCESS_TOOL_DISPLAY_SUMMARY, i as normalizeToolName } from "./tool-policy-shared-CnnYZoj3.js";
import { a as collectExplicitAllowlist, o as collectExplicitDenylist, r as applyOwnerOnlyToolPolicy, u as mergeAlsoAllowPolicy } from "./tool-policy-74_siKto.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-DsGaQCaM.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-DtcAqz4S.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-Bfwv9zjs.js";
import { a as copyBeforeToolCallHookMarker, c as isToolWrappedWithBeforeToolCallHook, d as copyChannelAgentToolMeta, m as listChannelAgentTools, u as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-BmZM4hyt.js";
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-cTpOgQ69.js";
import { i as asToolParamsRecord, l as jsonResult, r as ToolInputError } from "./common-V7-zd73S.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-LyOOU5fU.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-Ed-b-H7L.js";
...
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-CGz7P14C.js";
import "./codex-native-web-search-Bc2fjvqE.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-CcVFOxJ8.js";
import { t as bindAbortRelay } from "./fetch-timeout-BxQNNg4F.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-BDXF9cWN.js";
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-CB1BUrx4.js"));
...
//#endregion
export { TOOL_SEARCH_CODE_MODE_TOOL_NAME as a, applyToolSearchCatalog as c, projectToolSearchTargetTranscriptMessages as d, resolveToolSearchConfig as f, TOOL_DESCRIBE_RAW_TOOL_NAME as i, clearToolSearchCatalog as l, resolveProcessToolScopeKey as n, TOOL_SEARCH_RAW_TOOL_NAME as o, TOOL_CALL_RAW_TOOL_NAME as r, addClientToolsToToolSearchCatalog as s, createOpenClawCodingTools as t, createToolSearchCatalogRef as u };
