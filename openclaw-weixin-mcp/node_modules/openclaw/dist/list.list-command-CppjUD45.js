...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-Cdr1zbpf.js";
...
import { o as openAIProviderUsesCodexRuntimeByDefault } from "./openai-codex-routing-kS7Ub1vB.js";
...
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-wzqc0OTs.js";
import { c as hasUsableCustomProviderApiKey, s as hasSyntheticLocalProviderAuthConfig } from "./model-auth-_bXIM30P.js";
import { i as formatTokenK, n as ensureFlagCompatibility } from "./shared-klZNy1Fm.js";
import { n as loadModelsConfigWithSource } from "./load-config-CY0sDhRi.js";
import { n as formatErrorWithStack } from "./list.errors-D_5dFgdc.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-ksbH4IyB.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-CGzjW_Dl.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-j4yomUCi.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-BJ-_n_Ew.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-C4f-swUv.js"),
		import("./agent-scope-DMAwaA81.js"),
		import("./workspace-CXnpZfHn.js")
	]);
