...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-DHIk2CaO.js";
import { t as formatHelpExamples } from "./help-format-C6bIKvbJ.js";
import { t as runSecurityAudit } from "./audit-92-ju20j.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-BdjnnF3v.js");
