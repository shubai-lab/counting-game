...
import { T as pathExists, r as writeExternalFileWithinRoot } from "./fs-safe-DpJlqO1z.js";
...
import { t as resolveSystemBin } from "./resolve-system-bin-DW6XhD6P.js";
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-DgQ_QSz5.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DxFLCJCh.js";
import { t as describeImageWithModel } from "./image-runtime-pndfllVY.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-CRZ3dal0.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-DZ2OAK4b.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-Bt2vOwKb.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-DRFVyeJP.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-XY2S4fSb.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
