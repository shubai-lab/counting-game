...
import { w as trySafeFileURLToPath, x as hasEncodedFileUrlSeparator } from "./fs-safe-DpJlqO1z.js";
import { o as root } from "./secure-temp-dir-GC3bO7Qi.js";
import { c as isRecord$2, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-CKsuXgDI.js";
...
import { c as normalizeAgentId, p as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey } from "./session-key-DFEyR49L.js";
import { o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-26EcJVc0.js";
import { m as resolveSessionAgentIds, n as resolveAgentEffectiveModelPrimary, p as resolveSessionAgentId, r as resolveAgentExecutionContract } from "./agent-scope-C1Fl7gAf.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-M9JN_JCw.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-Cdr1zbpf.js";
...
import { t as logDebug } from "./logger-Dtrz4Rfi.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-5xE1dPMK.js";
import { h as isWindowsDrivePath } from "./archive-76p2JA6C.js";
...
import { o as normalizeChannelId } from "./registry-ere6Hdl3.js";
...
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-Coy_cvEz.js";
...
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-zsCdv7Ob.js";
import { g as synthesizeMediaGenerationCatalogEntries, h as listMediaGenerationProviderModels } from "./loader-DkTFEskE.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-CXxjiM_O.js";
import { n as assertSandboxPath } from "./sandbox-paths-BOOkw4YG.js";
import "./local-file-access-CxMyNsBJ.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-DPcc1MHX.js";
...
import { t as loadSessionStore, w as parseSessionThreadInfoFast } from "./store-load-cmAGD4uk.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BdfZSqhE2.js";
import { n as resolveSessionConversationRef } from "./session-conversation-kSBVRbLR.js";
...
import { c as extractDeliveryInfo } from "./sessions-BhOk6siH.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-Bg_OIUJn.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-DXB7r8u2.js";
import { b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-Dh1KrVmr.js";
import { n as modelKey$1, r as normalizeModelRef } from "./model-selection-normalize-B4tdZ1L4.js";
...
import { n as extractTextFromChatContent } from "./chat-content-Dc1e9mcQ.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-DnNkh3N1.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-D2PdwpaS.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-DSvCUilH.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-DAa8g4GN.js";
...
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-CnnYZoj3.js";
import "./tool-policy-74_siKto.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-CrK_CuOX.js";
import { a as resolvePluginTools } from "./tools-DsGaQCaM.js";
import { a as getImageMetadata } from "./image-ops-CL9ZQP7k.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-Bfwv9zjs.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-Dlz_vOyv.js";
import { c as isToolWrappedWithBeforeToolCallHook, h as listChannelSupportedActions, p as listAllChannelSupportedActions, u as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-BmZM4hyt.js";
...
import { r as getApiKeyForModel } from "./model-auth-_bXIM30P.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-cTpOgQ69.js";
import { n as extractAssistantText } from "./pi-embedded-utils-1bVAKyYK.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-DzsdC5tX.js";
import { n as runWithImageModelFallback } from "./model-fallback-CFP2h22a.js";
import { _ as readStringParam$1, h as readStringArrayParam, i as asToolParamsRecord, l as jsonResult, p as readNumberParam, r as ToolInputError, u as normalizeToolModelOverride, x as readSnakeCaseParamRaw } from "./common-V7-zd73S.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-CdR1r1Su.js";
...
import "./delivery-context-BNQMhn-L.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BjmmBRUl.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-DvTwLiTi.js";
...
import { o as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-0ARboxa_.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-BmlK3CV4.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-B44Du8nj.js";
import { r as stripToolMessages } from "./chat-history-text-DY_gaDpD.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-BznfLAkp.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-hEmtik2I.js";
import { t as inferLegacyName } from "./normalize-NlHGjCHZ.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-ljsW0Fal.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BB9T_Qba.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-uL2Fdx7C.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-BOxGxS8Y.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-Oyct10ZH.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-CMxSO5vZ.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-DDkiBYMh.js";
import { u as saveMediaBuffer } from "./store-b792nN7l.js";
import { t as SsrFBlockedError } from "./ssrf-CYoLqc2K.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-DzDTwL8L.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-BxQNNg4F.js";
import { r as getDefaultLocalRoots } from "./local-media-access-z1nEwng6.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-CqsT0huS.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig$1, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-BcnwK449.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-CBrAdukK.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-C4wW7L7-.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DxFLCJCh.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-C7Hv5EKy.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-pndfllVY.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-CRZ3dal0.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-C5LyBP70.js";
import { s as resolveTimeoutMs } from "./resolve-DZ2OAK4b.js";
import { t as buildProviderRegistry } from "./runner-DjFT6is3.js";
import "./media-understanding-CR4579N1.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-CF-WO5vi.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-5wOzhybC.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-DHIk2CaO.js";
import { a as resolveAllowedMessageActions, n as runMessageAction, o as POLL_CREATION_PARAM_DEFS, s as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-CejAfutx.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-DbwhVmZC.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BaqnvIBw.js";
import { n as findActiveSessionTask, t as buildSessionAsyncTaskStatusDetails } from "./session-async-task-status-CMHqODj-.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-CdJJiis1.js";
import { t as parseTimeoutMs } from "./parse-timeout-CTcD0lfv.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-4RVG134A.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DT1n7Zjn.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-BjTWOgZz.js";
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-DNQef1OS.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-BcTdpiLf.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-BZTQYrDg.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-_h1IivrF.js";
import { t as createModelVisibilityPolicy } from "./model-visibility-policy-H_5vLqqk.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-B7XP14wc.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DtmOWhw6.js";
import { _ as isReplySkip, f as runAgentStep, g as isNonDeliverableSessionsReply, h as isAnnounceSkip, m as REPLY_SKIP_TOKEN, p as ANNOUNCE_SKIP_TOKEN } from "./subagent-session-cleanup-B2dXoXCS.js";
...
import { p as registerSubagentRun } from "./subagent-registry-32aElbRE.js";
import { i as normalizeSubagentTaskName, n as SUBAGENT_SPAWN_CONTEXT_MODES, r as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-Bym_NHEH.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-zxvWGYKd.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-eVvq5Ces.js";
import { k as textToSpeech } from "./tts-runtime-C0bCA1Ve.js";
import "./tts-BO4bGOGk.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-BkcVUqlK.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-DwQQ0SPj.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CATO_xkV.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-CjyYcKYs.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-DoqyUDlD.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-CEPRrH8N.js";
...
import { i as runWebSearch } from "./runtime-DXf4_m8K.js";
import "./web-search-provider-common-CHdvpLZ1.js";
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-Dp9YaMFi.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-DIqzacR8.js"));
...
//#endregion
export { isStrictAgenticSupportedProviderModel as C, isParentOwnedBackgroundAcpSession as D, setEmbeddedMode as E, isStrictAgenticExecutionContractActive as S, isEmbeddedMode as T, wrapToolMemoryFlushAppendOnlyWrite as _, listRuntimeMusicGenerationProviders as a, sniffMimeFromBase64 as b, normalizeCronJobInput as c, createHostWorkspaceEditTool as d, createHostWorkspaceWriteTool as f, createSandboxedWriteTool as g, createSandboxedReadTool as h, generateMusic as i, normalizeCronJobPatch as l, createSandboxedEditTool as m, buildActiveVideoGenerationTaskPromptContextForSession as n, listSupportedMusicGenerationModes as o, createOpenClawReadTool as p, buildActiveMusicGenerationTaskPromptContextForSession as r, normalizeCronJobCreate as s, createOpenClawTools as t, resolveToolLoopDetectionConfig as u, wrapToolWorkspaceRootGuard as v, stripProviderPrefix as w, resolveOpenClawPluginToolsForOptions as x, wrapToolWorkspaceRootGuardWithOptions as y };
