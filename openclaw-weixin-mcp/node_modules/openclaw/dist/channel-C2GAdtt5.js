...
import { l as createScopedDmSecurityResolver } from "./channel-config-helpers-Dzal6cfS.js";
...
import { d as createDefaultChannelRuntimeState, l as createAsyncComputedAccountStatusAdapter } from "./status-helpers-Dk-3BT6p.js";
import { a as coerceStatusIssueAccountId, d as readStatusIssueFields, n as buildPassiveProbedChannelStatusSummary } from "./extension-shared-BznPIa-o.js";
...
import { a as resolveZalouserReactionMessageIds, o as buildZalouserGroupCandidates, s as findZalouserGroupEntry, t as getZalouserRuntime } from "./runtime-SLeRFzZl.js";
import { n as zalouserSetupAdapter, r as writeQrDataUrlToTempFile, t as createZalouserSetupWizardProxy } from "./setup-core-C3HYf_Ym.js";
import { i as resolveZalouserOutboundSessionRoute, n as parseZalouserDirectoryGroupId, r as parseZalouserOutboundTarget, t as normalizeZalouserTarget } from "./session-route-DDhCRDbz.js";
//#region extensions/zalouser/src/channel.adapters.ts
const loadZalouserChannelRuntime$1 = createLazyRuntimeModule(() => import("./channel.runtime-CeuXF4lT.js"));
...
const loadZalouserChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-CeuXF4lT.js"));
const zalouserSetupWizardProxy = createZalouserSetupWizardProxy(async () => (await import("./setup-surface-d7M4qGTF.js")).zalouserSetupWizard);
	...
	base: {
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				const { monitorZalouserProvider } = await import("./monitor-BU-ayxGN.js");
