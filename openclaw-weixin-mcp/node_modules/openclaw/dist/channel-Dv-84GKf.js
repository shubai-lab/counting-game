...
import { n as normalizeAtHashSlug } from "./string-normalization-DEwYgSEp.js";
...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-DAOnqNNq.js";
...
import { n as resolveTargetsWithOptionalToken } from "./target-resolvers-Dajov6Ez.js";
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-mQquCOrG.js";
import "./channel-api-BOOndQdW.js";
import { t as parseDiscordTarget } from "./target-parsing-DtUIjZoO.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-C5utVEqt.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-BAazq1Aa.js";
import { t as getDiscordRuntime } from "./runtime-BcSREH0s.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-DnyWhctb.js";
import { t as getDiscordApprovalCapability } from "./approval-native-yntDRqtb.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-CKdRCK-d.js";
import { t as discordMessageActions$1 } from "./channel-actions-h2oJzQ49.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-CdU70itQ.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-xb4FjW37.js";
import { n as discordOutbound } from "./outbound-adapter-Bn0wL6_l.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-N67bzioP.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-B1WIzONu.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-BNEgzHj_.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-BU90jVfo.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-CfYDEojR.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-CdDlY3Q3.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-Btr4PBLU.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-CAiJCG6S.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-BvrFsjo3.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-BYEW51da.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-BxFGw3le.js");
