import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-BYUMdBy8.js";
import { r as loadCrestodianOverview } from "./overview-Con_Lx_i.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-DcCxsSI8.js")).planCrestodianCommand)({
		input,
		overview
	});
