...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-BxqheYvy.js";
...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-CxXKjyWH.js";
import "./ssrf-runtime-B7YsbRmp.js";
import "./retry-runtime-BJ_J0SKw.js";
import "./secret-input-runtime-gpFmIyG1.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-C4Ffmv05.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DC8Gi9dP.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-DPIixDRe.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-D0-ECmEW.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-DWYwDVbi.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-C3IIIb5H.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-CXD8npTs.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-57fTsGV6.js"), import("./logging-BZ0-jTdz.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BQsj6Emt.js").then((credentialsReadModule) => ({
