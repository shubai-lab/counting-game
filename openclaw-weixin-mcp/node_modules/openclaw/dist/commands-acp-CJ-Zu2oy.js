...
import { a as requireGatewayClientScopeForInternalChannel } from "./command-gates-D7ejZbo7.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-DjFvKoGL.js";
//#region src/auto-reply/reply/commands-acp.ts
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-BJTjBROx.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-DRNOTixO.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-VPuLH_Rz.js"));
