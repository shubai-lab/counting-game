...
import { n as resolveDaemonInstallRuntimeInputs, o as resolveNodeProgramArguments, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DfEn0wKF.js";
...
import { a as decodeWindowsOutputBuffer, o as resolveWindowsConsoleEncoding } from "./windows-command-O_lLEVq_.js";
import { a as logWarn } from "./logger-Dtrz4Rfi.js";
import { i as getRuntimeConfig } from "./io-5xE1dPMK.js";
import { b as resolveExecutableFromPathEnv, d as resolveApprovalAuditCandidatePath, p as resolveCommandResolutionFromArgv } from "./exec-safe-bin-trust-C58pNRL_.js";
import { E as splitShellArgs, T as normalizeExecutableToken, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, h as extractEnvAssignmentKeysFromDispatchWrappers, l as isShellWrapperInvocation, m as resolveInlineCommandMatch, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, y as unwrapKnownDispatchWrapperInvocation } from "./shell-wrapper-resolution-CN1bWvVT.js";
import "./config-CzeRK-GW.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-ByBZDdph.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-BX5wgIHf.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-CmXmeC7j.js";
import { t as parsePort } from "./parse-port-CTD23XjJ.js";
...
import { t as ConnectErrorDetailCodes } from "./connect-error-details-Coy_cvEz.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-BzM-_jR9.js";
import { a as getActivePluginRegistry } from "./runtime-CFKT2mp_.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-Bjc3C9QN.js";
import { t as getMachineDisplayName } from "./machine-name-DSAEPbjN.js";
import { c as describeInterpreterInlineEval } from "./risks-Bk6GvAYC.js";
import { c as analyzeArgvCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-C8NiCGHW.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-Ed-b-H7L.js";
...
import { t as resolveGatewayConnectionAuth } from "./connection-auth-BTz63MM7.js";
import { t as formatHelpExamples } from "./help-format-C6bIKvbJ.js";
import { n as detectPolicyInlineEval } from "./policy-B6hR9n6m.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-BvuWDemN.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-wcrDNlng.js";
import { t as resolveNodeService } from "./node-service-CNO6-Tlm.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-ulzjAks5.js");
