...
import "./bundle-manifest-BL4DoREl.js";
import { i as fingerprintPluginDiscoveryContext, o as resolvePluginDiscoveryContext } from "./plugin-metadata-snapshot-DlaHO4z7.js";
import { g as isPluginEnabledByDefaultForPlatform, p as collectPluginManifestCompatCodes } from "./installed-plugin-index-store-DetkjvO9.js";
import { f as writeJsonSync, u as tryReadJsonSync } from "./json-files-CahFuwKs.js";
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-DLJ2h3Qv.js";
import { c as resolveEffectiveEnableState, d as resolveMemorySlotDecision, l as resolveEffectivePluginActivationState, n as createPluginActivationSource, s as normalizePluginsConfig, t as applyTestPluginDefaults } from "./config-state-BgyjpLHd.js";
...
import { n as getCachedPluginModuleLoader, s as toSafeImportPath, t as createPluginModuleLoaderCache } from "./plugin-module-loader-cache-MuKAXPrS.js";
import { a as listPluginSdkAliasCandidates, c as resolveExtensionApiAlias, f as resolvePluginRuntimeModulePath, g as shouldPreferNativeModuleLoad, h as resolvePluginSdkScopedAliasMap, m as resolvePluginSdkAliasFile, n as buildPluginLoaderJitiOptions, o as listPluginSdkExportedSubpaths, p as resolvePluginSdkAliasCandidateOrder, t as buildPluginLoaderAliasMap } from "./sdk-alias-npL7bYup.js";
...
import { i as getRuntimeConfigSnapshot, s as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-tLK3Mx7y.js";
...
import { n as listChatChannels } from "./chat-meta-DTmQp8Tt.js";
import { s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-s-A-ruKR.js";
import { t as normalizePluginGatewayMethodScope } from "./gateway-method-policy-wkwYae2r.js";
import { s as isOperatorScope } from "./operator-scopes-CpnZaPqz.js";
import { p as normalizeChannelMeta } from "./bundled-Q4WXUmmu.js";
...
import { t as unwrapDefaultModuleExport } from "./module-export-C7eualdo.js";
import { t as attachPluginApiFacades } from "./api-facades-B7aKRySD.js";
import { t as buildPluginApi } from "./api-builder-BgtzF-dV.js";
import { a as listRegisteredAgentHarnesses, c as restoreRegisteredAgentHarnesses, o as registerAgentHarness, r as getRegisteredAgentHarness, t as clearAgentHarnesses } from "./registry-481lFxWt.js";
import { G as resolveMemoryDreamingConfig, K as resolveMemoryDreamingPluginConfig, _ as DEFAULT_MEMORY_DREAMING_PLUGIN_ID } from "./dreaming-DWqFIr5P.js";
import { a as restoreDetachedTaskLifecycleRuntimeRegistration, i as registerDetachedTaskLifecycleRuntime, n as getDetachedTaskLifecycleRuntimeRegistration, t as clearDetachedTaskLifecycleRuntimeRegistration } from "./detached-task-runtime-state-jgdLXpsx.js";
import { n as inspectBundleMcpRuntimeSupport } from "./bundle-mcp-CFLIOQBM.js";
import { A as pluginCommands, E as clearPluginCommandsForPlugin, T as clearPluginCommands, _ as clearPluginInteractiveHandlersForPlugin, a as isConversationHookName, g as clearPluginInteractiveHandlers, h as validatePluginCommandDefinition, j as restorePluginCommands, k as listRegisteredPluginCommands, l as stripPromptMutationFieldsFromLegacyHookResult, o as isPluginHookName, p as registerPluginCommand, s as isPromptInjectionHookName, u as isReservedCommandName, v as listPluginInteractiveHandlers, x as restorePluginInteractiveHandlers, y as registerPluginInteractiveHandler } from "./types-Db71gsKA.js";
import { i as initializeGlobalHookRunner, t as getGlobalHookRunner } from "./hook-runner-global-aUo3QVZe.js";
import { a as resolveSetupChannelRegistration, i as resolveBundledRuntimeChannelRegistration, n as loadBundledRuntimeChannelPlugin, o as shouldLoadChannelPluginInSetupRuntime, r as mergeSetupRuntimeChannelPlugin, t as channelPluginIdBelongsToManifest } from "./loader-channel-setup-YlJ0gLmv.js";
import { a as listRegisteredMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider, r as getRegisteredMemoryEmbeddingProvider, s as restoreRegisteredMemoryEmbeddingProviders, t as clearMemoryEmbeddingProviders } from "./memory-embedding-providers-G_zj7dLG.js";
import { S as restoreMemoryPluginState, _ as registerMemoryPromptSectionForPlugin, b as registerMemoryRuntimeForPlugin, d as listMemoryPromptSupplements, f as registerMemoryCapability, h as registerMemoryFlushPlanResolverForPlugin, i as getMemoryCapabilityRegistration, p as registerMemoryCorpusSupplement, r as clearMemoryPluginState, u as listMemoryCorpusSupplements, v as registerMemoryPromptSupplement } from "./memory-state-C_iIBw9h.js";
import { i as withProfile } from "./plugin-load-profile-BSCTMdA8.js";
import { A as registerPluginSessionSchedulerJob, C as isPluginRegistryRetired, D as getPluginRunContext, E as deletePluginSessionSchedulerJob, F as isPluginJsonValue, I as createEmptyPluginRegistry, N as buildPluginAgentTurnPrepareContext, O as getPluginSessionSchedulerJobGeneration, P as normalizePluginHostHookId, S as isPluginRegistryActivated, T as clearPluginRunContext, a as getActivePluginRegistry, j as setPluginRunContext, l as getActivePluginRuntimeSubagentMode, o as getActivePluginRegistryKey, p as recordImportedPluginId, x as setActivePluginRegistry } from "./runtime-CFKT2mp_.js";
import { r as registerContextEngineForOwner, t as clearContextEnginesForOwner } from "./registry-CNnI9MEE.js";
import { f as registerInternalHook, h as unregisterInternalHook } from "./internal-hooks-C8Y435Ix.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, r as NODE_SYSTEM_NOTIFY_COMMAND } from "./node-commands-Bjc3C9QN.js";
import { t as createPluginStateKeyedStore } from "./plugin-state-store-agWe2J3x.js";
import { i as emitAgentEvent } from "./agent-events-CXxjiM_O.js";
import { a as normalizeAgentToolResultMiddlewareRuntimeIds, n as normalizePluginToolContractNames, o as normalizeAgentToolResultMiddlewareRuntimes, r as normalizePluginToolNames, t as findUndeclaredPluginToolNames } from "./tool-contracts-DrrZ2VcD.js";
import { n as resolveWorkspaceRoot, r as resolvePathFromInput } from "./workspace-dir-DPcc1MHX.js";
import { n as resolveAgentMainSessionKey } from "./main-session-BkilxHe0.js";
import { a as resolveSessionStoreKey, i as resolveSessionStoreAgentId } from "./combined-store-gateway-CrCDV3An.js";
...
import { r as resolveAllAgentSessionStoreTargetsSync } from "./targets-DaLztPKR.js";
import { c as extractDeliveryInfo } from "./sessions-BhOk6siH.js";
import { n as detectMime, t as FILE_TYPE_SNIFF_MAX_BYTES, u as normalizeMimeType } from "./mime-Bg_OIUJn.js";
import { i as normalizeSessionEntrySlotKey } from "./host-hook-cleanup-DaMlCN8H.js";
import { n as normalizePluginHttpPath, t as findOverlappingPluginHttpRoute } from "./http-route-overlap-D7fcTpXY.js";
import { i as withPluginRuntimePluginScope, r as withPluginRuntimePluginIdScope, t as getPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-v3GshBD5.js";
...
async function loadSendMessage() {
	sendMessagePromise ??= import("./message-DcTKQpgz.js").then((module) => module.sendMessage);
	return sendMessagePromise;
}
let getChannelPluginPromise;
async function loadGetChannelPlugin() {
	getChannelPluginPromise ??= import("./plugins-DJit8KgP.js").then((module) => module.getChannelPlugin);
...
//#endregion
export { getCompactionProvider as C, PluginLoadReentryError as S, drainPluginNextTurnInjectionContext as _, clearPluginRegistryLoadCache as a, projectPluginSessionExtensionsSync as b, loadOpenClawPluginCliRegistry as c, resolvePluginRegistryLoadCacheKey as d, resolveRuntimePluginRegistry as f, synthesizeMediaGenerationCatalogEntries as g, listMediaGenerationProviderModels as h, clearPluginLoaderCache as i, loadOpenClawPlugins as l, createRuntimeConfig as m, __testing as n, getRuntimePluginRegistryForLoadOptions as o, createPluginRegistry as p, clearActivatedPluginRuntimeState as r, isPluginRegistryLoadInFlight as s, PluginLoadFailureError as t, resolveCompatibleRuntimePluginRegistry as u, getPluginSessionExtensionStateSync as v, resolvePluginActivationSourceConfig as w, listCodexAppServerExtensionFactories as x, patchPluginSessionExtension as y };
