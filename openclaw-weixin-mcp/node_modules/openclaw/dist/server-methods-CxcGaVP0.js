...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-26EcJVc0.js";
import { p as resolveSessionAgentId } from "./agent-scope-C1Fl7gAf.js";
import { l as measureDiagnosticsTimelineSpan, u as measureDiagnosticsTimelineSpanSync } from "./plugin-metadata-snapshot-DlaHO4z7.js";
...
import { a as logWarn, t as logDebug } from "./logger-Dtrz4Rfi.js";
import "./auth-e6hlqNhL.js";
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-CX86Ah73.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-5xE1dPMK.js";
import "./archive-76p2JA6C.js";
...
import { f as normalizeReasoningLevel, p as normalizeThinkLevel } from "./thinking-ix_990qw.js";
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-CbjHCImG.js";
import { h as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-tLK3Mx7y.js";
...
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-CZkSQL9n.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-DWqFIr5P.js";
import { y as patchPluginSessionExtension } from "./loader-DkTFEskE.js";
import { F as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-CFKT2mp_.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-C8Y435Ix.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-CXxjiM_O.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-BkilxHe0.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CrCDV3An.js";
import { h as stringifyRouteThreadId } from "./channel-route-jaZFObQA.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-Dk7-07JJ.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-kGAxo7MN.js";
import { t as loadSessionStore } from "./store-load-cmAGD4uk.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BdfZSqhE2.js";
...
import { c as extractDeliveryInfo, i as serializeSessionCleanupResult, o as resolveSessionLifecycleTimestamps, r as runSessionsCleanup, s as resolveMainSessionKeyFromConfig, t as purgeAgentSessionStoreEntries } from "./sessions-BhOk6siH.js";
...
import { d as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-Dh1KrVmr.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CrCOUFln.js";
import { t as resolveAgentTimeoutMs } from "./timeout-B90p_5rC.js";
import { c as setHeartbeatsEnabled } from "./heartbeat-wake-DMnOjlhb.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-D_-_Inav.js";
import { t as extractToolPayload } from "./tool-payload-7BJfgmNg.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-D2PdwpaS.js";
import { d as listTaskRecords, s as getTaskById } from "./task-registry-DFUW-xBJ.js";
import "./runtime-internal-Bqu0JS7i.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId, t as cancelDetachedTaskRunById } from "./detached-task-runtime-DSvCUilH.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-BvIK-BSF.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-BC36t-9c.js";
...
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, t as buildRestartSuccessContinuation } from "./restart-sentinel-DAa8g4GN.js";
import { l as getTotalQueueSize } from "./command-queue-DB7xEnvP.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-3s01UZfv.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-gbHgqdM1.js";
import { l as normalizeCronJobPatch, s as normalizeCronJobCreate } from "./openclaw-tools-BfDU2PXL.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-CnnYZoj3.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-DsGaQCaM.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-D_wyg8rY.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-BNTZ_9-b.js";
...
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-Yd9K5coJ.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-BDG5_K6J.js";
import { i as createOutboundPayloadPlan, u as projectOutboundPayloadPlanForMirror } from "./deliver-BFTTkM5p.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-F42asPlK.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-DvTwLiTi.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-BCvCZvLv.js";
import { i as resolveIngressWorkspaceOverrideForSpawnedRun, r as normalizeSpawnedRunMetadata } from "./spawn-requester-origin-0ARboxa_.js";
import { i as parseAbsoluteTimeMs } from "./stagger-hEmtik2I.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-ljsW0Fal.js";
...
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-C3NqlKLT.js";
import { c as dispatchChannelMessageAction, i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry } from "./message-action-runner-CejAfutx.js";
import { o as resolveTrustedGroupId } from "./pi-tools.policy-BYHXXrrP.js";
...
import "./target-resolver-DNvze0Ma.js";
import { i as resolveReplyToMode } from "./reply-threading-BisJAziy.js";
...
import { i as validateTargetProviderPrefix, r as resolveTargetPrefixedChannel } from "./targets-session-C2phrKPn.js";
import { r as resolveOutboundTarget } from "./targets-C4KDj7eL.js";
import { n as resolveAgentIdentity } from "./identity-CRZts9Qd.js";
import { s as clearSessionQueues } from "./queue-B4F7vEmJ.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-Cetcl-az.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-CUpdXOkd.js";
import { o as getGatewayModelPricingHealth } from "./model-pricing-cache-state-BeDGQcmt.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-DNQef1OS.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-BllhWpEO.js";
...
import { i as listSpeechProviders, n as getSpeechProvider, t as canonicalizeSpeechProviderId } from "./provider-registry-CvN-bC19.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-FoGW3i1-.js";
import "./commands-registry-CPSWhUW1.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-Cpa7arOZ.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-C945YHg-.js";
...
import "./browser-maintenance-D0FGFp1C.js";
import { c as performGatewaySessionReset } from "./session-reset-service-CZlxWK9Q.js";
import { t as getPluginCommandSpecs } from "./command-specs-B7OJWPwd.js";
import { r as listPluginCommands } from "./commands-w9uHmCLc.js";
import { t as getChannelActivity } from "./channel-activity-zWUQ9Yny.js";
import { t as WizardCancelledError } from "./prompts-w_QiqAiL.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-C0cTZv13.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DcBADiZC.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-BG7rfARM.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-Cs80gCmb.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-398GljfQ.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-Dwaxzqx8.js";
import { r as agentCommandFromIngress } from "./agent-command-BQgTSh4F.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-DP56WFmQ.js";
import { n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-rX_utHfg.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-C6DTE9FR.js";
import { t as formatForLog } from "./ws-log-CjqaGuge.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-C47Deh81.js";
import { t as canExecRequestNode } from "./exec-defaults-CwIA892j.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-BUsweahD.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-Df-LNfRp.js";
import { t as getRemoteSkillEligibility } from "./skills-remote-sP-UA4tV.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-D7lNGMWZ.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-BCvVLdb-.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-jhsMNs7J.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-Dv7_fvdF.js";
import { A as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, S as recordTalkObservabilityEvent, a as listRealtimeVoiceProviders, b as createTalkSessionController, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, n as resolveConfiguredRealtimeVoiceProvider, r as canonicalizeRealtimeVoiceProviderId, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession, u as buildRealtimeVoiceAgentConsultChatMessage } from "./session-runtime-CA9Yhu5F.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-ilPwVSe1.js";
import { n as createOutboundSendDeps } from "./deps-eRxJcC0K.js";
import "./agent-834cof0Q.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-BgDGzd8n.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-BvuWDemN.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-DLRLkGKE.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-rVsDSzEN.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BP7MHRkz.js";
import "./server-constants-1JM0IS0k.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-DxL9Ld5b.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController, t as abortChatRunById } from "./chat-abort-BJLHIlT_.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CdYspVKW.js";
...
import { t as loadProviderUsageSummary } from "./provider-usage-DyqtWD4c.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-Dve1vgj1.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-DCCXDhLO.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-CFJ2soy5.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-DYpdhTj7.js";
import { t as buildChannelUiCatalog } from "./catalog-BcLSNZAU.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-aulFgURT.js";
import { s as normalizeUpdateChannel } from "./update-channels-BzDuK5ra.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-C9vXpfG_.js";
import { t as readConfiguredLogTail } from "./log-tail-ByVTdGQi.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-Cmpjpkhp.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-DfCFY8du.js";
...
import { t as installSkill } from "./skills-install-Cf83DG0-.js";
import { r as readPackageVersion } from "./package-json-V9xrToDq.js";
import { t as getStatusSummary } from "./status.summary-CZND_jzu.js";
import "./status-D8dESP54.js";
import { a as installSkillArchiveFromPath, i as updateSkillsFromClawHub, o as validateRequestedSkillSlug, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-CaCAIBVk.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-H-pPQ1P6.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-DZiYYrEB.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-W9q-QunV.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-NFp6W-HO.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-DAdcLkHa.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-StRnW2pG.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DS9IsKts.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-BPq0Nxmu.js";
import "./heartbeat-runner-CZ9fBpWc.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-BggFg1sK.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-DYBz64u-.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-BmLty9AW.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-C-X2iglb.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-7LE1khPP.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-B5-RGuk_.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-DrtzxkAM.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-Cq5C1NWC.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-D6y0H8SA.js");
