...
import { c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-26EcJVc0.js";
...
import { r as loadOrCreateDeviceIdentity } from "./device-identity-Ls7H5sHg.js";
...
import { n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-BkilxHe0.js";
...
import { s as updateSessionStore, t as archiveRemovedSessionTranscripts } from "./store-3qAZ3Zl6.js";
...
import { a as isRetryableHeartbeatBusySkipReason, i as areHeartbeatsEnabled, n as HEARTBEAT_SKIP_LANES_BUSY, o as requestHeartbeat, r as HEARTBEAT_SKIP_REQUESTS_IN_FLIGHT, s as setHeartbeatWakeHandler, t as HEARTBEAT_SKIP_CRON_IN_PROGRESS } from "./heartbeat-wake-DMnOjlhb.js";
import { c as peekSystemEventEntries, d as resolveSystemEventDeliveryContext, t as consumeSelectedSystemEventEntries } from "./system-events-D_-_Inav.js";
import { t as sanitizeAssistantVisibleText } from "./assistant-visible-text-DnNkh3N1.js";
import { c as getQueueSize, s as getCommandLaneSnapshots } from "./command-queue-DB7xEnvP.js";
import { n as hasActiveCronJobs } from "./active-jobs-C6GKlDWE.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-BOrd8HRU.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-CUA96vf1.js";
import { a as isHeartbeatContentEffectivelyEmpty, c as resolveHeartbeatPrompt$1, l as resolveHeartbeatPromptForResponseTool, o as isTaskDue, s as parseHeartbeatTasks, u as stripHeartbeatToken } from "./heartbeat-DJ4ZZ8Yg.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-DK108U9s.js";
import { r as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-BNTZ_9-b.js";
import { a as getHeartbeatToolNotificationText, s as resolveHeartbeatToolResponseFromReplyResult } from "./heartbeat-tool-response-cTpOgQ69.js";
...
import { n as resolveHeartbeatSenderContext, t as resolveHeartbeatDeliveryTarget } from "./targets-C4KDj7eL.js";
import { t as resolveEmbeddedSessionLane } from "./lanes-BQ7rTa0w.js";
import { n as resolveResponsePrefixTemplate } from "./response-prefix-template-7coqW3KI.js";
import { n as isNestedAgentLane } from "./lanes-B7XP14wc.js";
import { i as resolveUserTimezone } from "./date-time-D45sDlB1.js";
import { t as appendCronStyleCurrentTimeLine } from "./current-time-DuuID261.js";
...
import { n as listDueCommitmentSessionKeys, o as markCommitmentsAttempted, r as listDueCommitmentsForSession, s as markCommitmentsStatus } from "./store-t9Y6uavK.js";
...
import { a as isRelayableExecCompletionEvent, i as isExecCompletionEvent, n as buildExecEventPrompt, r as isCronSystemEvent, t as buildCronEventPrompt } from "./heartbeat-events-filter-CSt7zU2j.js";
import { a as resolveIndicatorType, t as emitHeartbeatEvent } from "./heartbeat-events-Cs80gCmb.js";
import { t as resolveHeartbeatVisibility } from "./heartbeat-visibility-C2THeR71.js";
import { t as resolveCronSession } from "./session-CjidLsIB.js";
...
function normalizeHeartbeatReply(payload, responsePrefix, ackMaxChars) {
	const stripped = stripHeartbeatToken(stripLeadingHeartbeatResponsePrefix(sanitizeAssistantVisibleText(typeof payload.text === "string" ? payload.text : ""), responsePrefix), {
		mode: "heartbeat",
...
function isInternalHeartbeatNoticePayload(payload) {
...
async function runHeartbeatOnce(opts) {
	...
	try {
		...
		if (!heartbeatToolResponse && (!canUseReplyPayload || !replyPayload || !hasOutboundReplyContent(replyPayload))) {
			await restoreHeartbeatUpdatedAt({
				storePath,
				sessionKey,
				updatedAt: previousUpdatedAt
		...
		const normalized = heartbeatToolResponse ? normalizeHeartbeatToolNotification(heartbeatToolResponse, responsePrefix) : canUseReplyPayload && replyPayload ? normalizeHeartbeatReply(replyPayload, responsePrefix, ackMaxChars) : {
			shouldSkip: true,
			text: "",
			hasMedia: false
		};
		const execFallbackText = !heartbeatToolResponse && !usesHeartbeatResponseTool && hasRelayableExecCompletion && !normalized.text.trim() && replyPayload?.text?.trim() ? replyPayload.text.trim() : null;
		if (execFallbackText) {
		...
		const mediaUrls = heartbeatToolResponse || !canUseReplyPayload || !replyPayload ? [] : resolveSendableOutboundReplyParts(replyPayload).mediaUrls;
