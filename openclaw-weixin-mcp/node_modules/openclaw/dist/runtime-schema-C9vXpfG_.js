...
import { t as CHANNEL_IDS } from "./ids-DFu3Ho6n.js";
...
import { D as collectPluginSchemaMetadata, E as collectChannelSchemaMetadata, O as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA, i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-5xE1dPMK.js";
...
import { r as isSensitiveUrlConfigPath, t as SENSITIVE_URL_HINT_TAG } from "./redact-sensitive-url-B6MY8QGf.js";
import { a as isSensitiveConfigPath } from "./redact-snapshot-D_wyg8rY.js";
...
function listHeartbeatTargetChannels(channels) {
	...
	return [...seen].toSorted((left, right) => left.localeCompare(right, "en", { sensitivity: "base" }));
}
